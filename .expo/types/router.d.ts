...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/_sitemap` | `/components/CustomButton` | `/components/FormField` | `/data` | `/firebaseConfig` | `/home` | `/profile` | `/sign-in` | `/sign-up` | `/survey` | `/trips` | `/upload`;
